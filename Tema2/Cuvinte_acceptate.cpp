...
/*
    Format fisier: lungime maxima cuvinte, stare initiala, nr stari finale, stari finale, nr tranzitii, tranzitii
    Format linie matrice: stare de plecare, stare in care ajungem, litera (nimic pentru lambda) 
*/

class Automat{
    int nrStariFinale, tranzitii, lungimeCuvinte;
    char stareCurenta;
    char* stariFinale;
    char** matriceAutomat;
    string drum;
...
void Automat::citireAutomat(const string& numeFisier){
    ...
    f >> this->lungimeCuvinte >> this->stareCurenta >> this->nrStariFinale;
